...
def get_lessons(group: str):
    ...
    try:
        ...
        classes[group] = {"0": ["Server Error", "Server Error", "Server Error","Server Error", "Server Error", "Server Error"], "1": ["Server Error", "Server Error", "Server Error","Server Error", "Server Error", "Server Error"],"2": ["Server Error", "Server Error", "Server Error","Server Error", "Server Error", "Server Error"],"3": ["Server Error", "Server Error", "Server Error","Server Error", "Server Error", "Server Error"],"4": ["Server Error", "Server Error", "Server Error","Server Error", "Server Error", "Server Error"],"5": ["Server Error", "Server Error", "Server Error","Server Error", "Server Error", "Server Error"]}

    #объединяем перемены с уроками
